        ...
        if (node.value != value) {
            if (node.value < value) {
                ...
                if (node.left == null) {
                    ...
                    node.right.color = Color.RED; // может left
                } else {
    ...
    private Node balance(Node node) {
        ...
        do {
            ...
            if (cur.right != null && cur.right.color == Color.RED
                    && (cur.left == null || cur.left.color == Color.BLACK)) { // вместо или и
                cur = leftRotate(cur);
                flag = true;
            }

            if (cur.left != null && cur.left.color == Color.RED && cur.left.left != null
